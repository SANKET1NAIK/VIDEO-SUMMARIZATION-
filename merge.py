...
video_path = os.path.join(VIDEOS_DIR, "20250213_20250213104750_20250213104803_104748.mp4")
...
feeder_model_path = os.path.join(".", "runs", "detect", "train", "weights", "feeder.pt")
